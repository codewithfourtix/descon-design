...
DATA.nav = [
  ...
  {subhead:'Fertilizer Plants — EPC'},
  {id:'urea',    label:'Urea',                icon:'sheet',     product:true},
  {id:'ammonia', label:'Ammonia',             icon:'sheet',     product:true},
  {id:'nitric',  label:'Nitric Acid',         icon:'sheet',     product:true},
  {id:'can',     label:'CAN',                 icon:'sheet',     product:true},
  {id:'np',      label:'NP / Agri Nutrients', icon:'sprout',    product:true},
  {subhead:'Shared Utilities'},
  {id:'ou',      label:'Utilities & Off-Gas', icon:'gauge',     product:true},
